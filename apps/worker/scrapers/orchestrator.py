...
from libs.core.config import MAX_JOBS_PER_PORTAL, FRESHER_KEYWORDS
...
class ScraperOrchestrator:
    ...
    async def run(self) -> list[RawJob]:
        api_scrapers = [RemotiveScraper, RemoteOKScraper, ArbeitnowScraper, AdzunaScraper, RapidAPIScraper, FreshersNowScraper]
        browser_scrapers = [IntershalaScraper, NaukriScraper, LinkedInScraper]
