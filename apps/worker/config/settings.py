...
MAX_JOBS_PER_PORTAL = 100     # Reduced from 500 for better stability
PLAYWRIGHT_HEADLESS = True
PLAYWRIGHT_SLOW_MO = 1000     # Increased to reduce CPU spikes
MEMORY_SAVER_MODE = os.getenv("MEMORY_SAVER_MODE", "True").lower() == "true"
NLP_MAX_WORKERS = int(os.getenv("NLP_MAX_WORKERS", "2")) # Reduced from 4
